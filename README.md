...
* 프로젝트는 반드시 구글의 기술을 1가지 이상 사용하여야 합니다. 기술의 리스트는 `자주하는 질문`을 참조하세요.
...
4. 2014년 2월 4일부터 인터넷을 통해 접근할 수 있으며 이탈리아, 퀘벡, 쿠바, 이란, 시리아, 북한, 수단 그리고 법으로 금지된 장소에서의 컨테스트 접근은 무효로 처리됩니다.
